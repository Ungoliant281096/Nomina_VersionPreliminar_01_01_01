Public Class CAP_CatCuentasMayor
    ...
    Private Sub CAP_CatCuentasMayor_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        For i As Integer = 1 To largoCatalogoMayor
            ...
            DataGridView1.Rows.Add(CATMAY.B1, CATMAY.B2)
        Next i
        ...
        DataGridView1.Columns(1).Width = 275 : DataGridView1.Columns(1).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter : DataGridView1.Columns(1).HeaderText = "Nombre" : DataGridView1.Columns(1).HeaderCell.Style.Font = New Font(DataGridView1.Font, FontStyle.Bold)
    End Sub
